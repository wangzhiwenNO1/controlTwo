            ...
            <div class="leftBoxs">
                <div class="leftTop itemBox">
                    ...
                    <div class="quickRow quick">
                        <div><i class="icon-cjxbj"></i> 创建新报价</div>
                        <div><i class="icon-yqkh"></i> 邀请客户</div>
                    </div>
                    <div class="quickRow quick">
                        <div><i class="icon-xsb"></i> 添加新设备</div>
                        <div><i class="icon-hzf"></i> 链接新合作方</div>
                    </div>
                </div>
